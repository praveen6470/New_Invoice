...
class Clientformupdate extends React.Component {
  ...
  render() {
    ...
    <Tabs defaultActiveKey="1" renderTabBar={renderTabBar}>
      <TabPane tab="Tab 1" key="1" style={{ height: 1500 }}>
        <h2>
          <strong style={{ paddingLeft: 0 }}><img style={{width:80, marginLeft:90}} src={require('../../image/logo.jpg')} />UPDATE INVOICE</strong>
        </h2>
        <img
        ...
        <Row>
          ...
          >
            <Col span={24}>
              ...
              <Button type="primary" style={{ marginLeft: 147 }}>
                Submit
              </Button>
            </Col>
